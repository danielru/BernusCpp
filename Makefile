...
all: probe_bernus_functions.out probe_bernus.out integrate_bernus.out test_bernus_steadystate.out
...
integrate_bernus.out: integrate_bernus.cpp bernus.hpp bernus.cpp bernus_functions.hpp
	$(CXX) $(FLAGS) integrate_bernus.cpp -o integrate_bernus.out
...
probe_bernus.out: probe_bernus.cpp bernus.cpp bernus.hpp bernus_functions.hpp
